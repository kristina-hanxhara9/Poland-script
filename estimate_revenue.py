...
def main():
    ...
    for idx, row in rows_to_process.iterrows():
        ...
        out = {
            ...
            "market_multiplier": est.get("market_multiplier", ""),
            "inflation_multiplier": est.get("inflation_multiplier", ""),
            "sector_trend_multiplier": est.get("sector_trend_multiplier", ""),
            "gdp_multiplier": est.get("gdp_multiplier", ""),
            "sector_growth_pct": est.get("sector_growth_pct", ""),
            "gdp_growth_pct": est.get("gdp_growth_pct", ""),
            "eur_pln_rate": est.get("eur_pln_rate", ""),
            "eur_pln_change_pct": est.get("eur_pln_change_pct", ""),
